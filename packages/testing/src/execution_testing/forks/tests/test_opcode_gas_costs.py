...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            Osaka.gas_costs().CODE_DEPOSIT_PER_BYTE * 100
            + Osaka.memory_expansion_gas_calculator()(new_bytes=32),
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            Osaka,
            Op.ADD + Op.SUB,
            Osaka.gas_costs().VERY_LOW * 2,
            id="sum_of_opcodes",
        ),
        pytest.param(
            Osaka,
            Op.ADD(1, 1),
            Osaka.gas_costs().VERY_LOW * 3,
            id="opcode_with_args",
        ),
        pytest.param(
            Osaka,
            Op.SSTORE(1, 2, key_warm=True),
            Osaka.gas_costs().STORAGE_SET + Osaka.gas_costs().VERY_LOW * 2,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            Osaka.gas_costs().REFUND_STORAGE_CLEAR,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            + Op.SSTORE(original_value=1, new_value=0),
            Osaka.gas_costs().REFUND_STORAGE_CLEAR * 2,
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            Op.SLOAD(page_load_warm=True),
            _gc.PAGE_BASE_COST,
            id="sload_warm_page",
        ),
        pytest.param(
            Op.SLOAD(page_load_warm=False),
            _gc.PAGE_LOAD_COST + _gc.PAGE_BASE_COST,
            id="sload_cold_page",
        ),
    ],
)
    ...
    [
        ...
        pytest.param(
            ...
            (
                ...
                + _gc.PAGE_WRITE_COST
                + _gc.PAGE_BASE_COST
                + _gc.PAGE_STATE_GROWTH_COST
            ),
            id="create_slot_cold_page_new_peak",
        ),
        pytest.param(
            Op.SSTORE(
                page_load_warm=True,
            ...
            id="create_slot_loaded_unwritten_page_new_peak",
        ),
        pytest.param(
            Op.SSTORE(
                page_load_warm=True,
            ...
            _gc.PAGE_BASE_COST + _gc.PAGE_STATE_GROWTH_COST,
            id="create_slot_warm_page_new_peak",
        ),
        pytest.param(
            Op.SSTORE(
                page_load_warm=True,
            ...
            _gc.PAGE_BASE_COST,
            id="create_slot_warm_page_below_peak",
        ),
        pytest.param(
            Op.SSTORE(
                page_load_warm=True,
        ...
        pytest.param(
            ...
            (_gc.PAGE_LOAD_COST + _gc.PAGE_WRITE_COST + _gc.PAGE_BASE_COST),
            id="clear_slot_cold_page",
        ),
        pytest.param(
            Op.SSTORE(
                page_load_warm=True,
...
def test_mip8_sstore_no_refunds() -> None:
    """MIP-8 removes all SSTORE refunds."""
    clear_op = Op.SSTORE(
        page_load_warm=True,
        page_write_warm=True,
        current_value=5,
