...
GAS_STORAGE_UPDATE = Uint(5000 + 6000)
...
GAS_BLAKE2_PER_ROUND = Uint(1 * 2)
GAS_COLD_SLOAD = Uint(2100 + 6000)
GAS_COLD_ACCOUNT_ACCESS = Uint(2600 + 7500)
GAS_WARM_ACCESS = Uint(100)
GAS_INIT_CODE_WORD_COST = Uint(2)
GAS_BLOBHASH_OPCODE = Uint(3)
GAS_POINT_EVALUATION = Uint(50000 * 4)
GAS_ALT_BN128_ADD = Uint(150 * 2)
GAS_ALT_BN128_MUL = Uint(6000 * 5)
GAS_ALT_BN128_PAIRING_BASE = 45000 * 5
