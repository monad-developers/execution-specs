...
class Withdrawal:
    ...
    [`block`]: ref:ethereum.forks.monad_ten.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:ethereum.crypto.hash.keccak256
    [RLP]: https://ethereum.github.io/ethereum-rlp/src/ethereum_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:ethereum.forks.monad_ten.fork.EMPTY_OMMER_HASH
    """
    ...
    [logs bloom]: ref:ethereum.forks.monad_ten.bloom.logs_bloom
    """
...
class Block:
    ...
    [`header`]: ref:ethereum.forks.monad_ten.blocks.Header
    [withdrawals]: ref:ethereum.forks.monad_ten.blocks.Withdrawal
    """
    ...
    [headers]: ref:ethereum.forks.monad_ten.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:ethereum.forks.monad_ten.vm.instructions.log.log0
    [`LOG1`]: ref:ethereum.forks.monad_ten.vm.instructions.log.log1
    [`LOG2`]: ref:ethereum.forks.monad_ten.vm.instructions.log.log2
    [`LOG3`]: ref:ethereum.forks.monad_ten.vm.instructions.log.log3
    [`LOG4`]: ref:ethereum.forks.monad_ten.vm.instructions.log.log4
    """
