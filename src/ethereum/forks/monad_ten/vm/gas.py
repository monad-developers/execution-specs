...
# Monad MIP-3: linear memory pricing parameters.
MAX_TX_MEMORY_USAGE = 8 * 1024 * 1024
MEMORY_WORDS_PER_GAS = Uint(2)


def page_index(slot: U256) -> U256:
    """
...
class GasCosts:
    ...
    COLD_ACCOUNT_ACCESS: Final[Uint] = Uint(2600 + 7500)
    COLD_STORAGE_ACCESS: Final[Uint] = Uint(2100 + 6000)

    # Storage
    STORAGE_SET: Final[Uint] = Uint(20000)
    COLD_STORAGE_WRITE: Final[Uint] = Uint(5000 + 6000)

    # MIP-8 page-based storage
    PAGE_BASE_COST: Final[Uint] = Uint(100)
    PAGE_LOAD_COST: Final[Uint] = Uint(8000)
    PAGE_WRITE_COST: Final[Uint] = Uint(2800)
    PAGE_STATE_GROWTH_COST: Final[Uint] = Uint(17000)
    ...
    # Precompiles
    PRECOMPILE_ECRECOVER: Final[Uint] = Uint(3000 * 2)
    ...
    PRECOMPILE_BLAKE2F_PER_ROUND: Final[Uint] = Uint(1 * 2)
    PRECOMPILE_POINT_EVALUATION: Final[Uint] = Uint(50000 * 4)
    ...
    PRECOMPILE_ECADD: Final[Uint] = Uint(150 * 2)
    PRECOMPILE_ECMUL: Final[Uint] = Uint(6000 * 5)
    PRECOMPILE_ECPAIRING_BASE: Final[Uint] = Uint(45000 * 5)
    PRECOMPILE_ECPAIRING_PER_POINT: Final[Uint] = Uint(34000 * 5)

    # Blobs
    PER_BLOB: Final[U64] = U64(2**17)
    BLOB_SCHEDULE_TARGET: Final[U64] = U64(6)
    BLOB_TARGET_GAS_PER_BLOCK: Final[U64] = PER_BLOB * BLOB_SCHEDULE_TARGET
    BLOB_BASE_COST: Final[Uint] = Uint(2**13)
    BLOB_SCHEDULE_MAX: Final[U64] = U64(9)
    BLOB_MIN_GASPRICE: Final[Uint] = Uint(1)
    BLOB_BASE_FEE_UPDATE_FRACTION: Final[Uint] = Uint(5007716)
    ...
    TX_MAX_GAS_LIMIT: Final[Uint] = Uint(30_000_000)
...
def calculate_memory_gas_cost(size_in_bytes: Uint) -> Uint:
    ...
    # Monad MIP-3 linear memory pricing.
