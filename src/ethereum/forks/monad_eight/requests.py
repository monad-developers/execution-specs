...
[rh]: ref:ethereum.forks.monad_eight.blocks.Header.requests_hash
[dt]: ref:ethereum.forks.monad_eight.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:ethereum.forks.monad_eight.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:ethereum.forks.monad_eight.requests.CONSOLIDATION_REQUEST_TYPE
[pd]: ref:ethereum.forks.monad_eight.requests.parse_deposit_requests
[crh]: ref:ethereum.forks.monad_eight.requests.compute_requests_hash
[pgpr]: ref:ethereum.forks.monad_eight.fork.process_general_purpose_requests
"""
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:ethereum.forks.monad_eight.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:ethereum.forks.monad_eight.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:ethereum.forks.monad_eight.requests.DEPOSIT_REQUEST_TYPE
    """
