...
@pytest.mark.parametrize(
    "nonzero_bytes",
    [
        # Keep the floor boundary above the access-list intrinsic cost
        # (asserted in the test body): each nonzero byte adds 64 gas to
        # the floor but only 16 to the intrinsic cost.
