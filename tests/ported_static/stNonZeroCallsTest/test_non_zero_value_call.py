...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stNonZeroCallsTest/NonZeroValue_CALLFiller.json",  # noqa: E501
    ],
)
...
def test_non_zero_value_call(
    ...
    # Slot 100 measures gas consumed by CALL (cold) + callee cold SLOAD.
    ...
    post = {
        contract: Account(storage={1: 1, 100: 56435 + gas_adj}),
    }
