...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stNonZeroCallsTest/NonZeroValue_DELEGATECALL_ToNonNonZeroBalanceFiller.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_non_zero_value_delegatecall_to_non_non_zero_balance(
    ...
    post = {
        contract: Account(storage={1: 1, 100: 24732 + gas_adj}),
    }
