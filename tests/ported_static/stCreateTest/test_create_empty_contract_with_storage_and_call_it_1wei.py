...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCreateTest/CREATE_EmptyContractWithStorageAndCallIt_1weiFiller.json",  # noqa: E501
    ],
)
    ...
    post = {
        contract: Account(
            storage={
                ...
                3: 1,
                100: 0x62D37 - (0x62D37 - 0x58350 if fork >= MONAD_NINE else 0),
            },
        ),
