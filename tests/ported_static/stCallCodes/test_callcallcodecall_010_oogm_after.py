...
Ported from:
tests/static/state_tests/stCallCodes/callcallcodecall_010_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcallcodecall_010_OOGMAfterFiller.json",  # noqa: E501
    ],
)
