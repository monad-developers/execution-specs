...
Ported from:
tests/static/state_tests/stCallCodes/callcallcallcode_001_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcallcallcode_001_OOGMAfterFiller.json",  # noqa: E501
    ],
)
...
def test_callcallcallcode_001_oogm_after(
    ...
    # cheap enough to not OOG, so the inner CALL succeeds (slot 0 = 1).
    if fork >= MONAD_NINE:
