...
Ported from:
tests/static/state_tests/stCallCodes/callcodecallcall_100_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcodecallcall_100_OOGMAfterFiller.json",  # noqa: E501
    ],
)
...
def test_callcodecallcall_100_oogm_after(
    ...
    if fork >= MONAD_NINE:
        post = {contract: Account(storage={0: 1, 1: 1, 11: 1})}
    else:
