"""
CALLCODE -> CALLCODE2 -> CALLCODE3 -> CALLCODE2 -> ...  the gas usage is...
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcodecallcodecallcode_ABCB_RECURSIVEFiller.json",  # noqa: E501
    ],
)
...
def test_callcodecallcodecallcode_abcb_recursive(
    ...
    """CALLCODE -> CALLCODE2 -> CALLCODE3 -> CALLCODE2 -> ...  the gas..."""
