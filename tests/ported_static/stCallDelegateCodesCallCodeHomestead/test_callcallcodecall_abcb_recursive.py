"""
CALLCODE -> DELEGATECALL -> CALLCODE2 -> DELEGATECALL -> CALLCODE2 -> ...
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcallcodecall_ABCB_RECURSIVEFiller.json",  # noqa: E501
    ],
)
...
def test_callcallcodecall_abcb_recursive(
    ...
    """CALLCODE -> DELEGATECALL -> CALLCODE2 -> DELEGATECALL ->..."""
