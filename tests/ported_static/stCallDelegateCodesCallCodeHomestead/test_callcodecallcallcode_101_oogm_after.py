"""
DELEGATE -> (CALLCODE -> DELEGATE -> CODE) OOG.
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcodecallcallcode_101_OOGMAfterFiller.json",  # noqa: E501
    ],
)
...
def test_callcodecallcallcode_101_oogm_after(
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALLCODE(
                    gas=0x927C0,
                    address=0xDA11FDF0CE02240C6B4711F56AFCD9763B44D3DC,
                    value=0x0,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x5afccf55d80f6c4c95515cffd8e7d51d2c4c9f4a"),  # noqa: E501
    )
    pre.deploy_contract(
    ...
    pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xda11fdf0ce02240c6b4711f56afcd9763b44d3dc"),  # noqa: E501
    )
