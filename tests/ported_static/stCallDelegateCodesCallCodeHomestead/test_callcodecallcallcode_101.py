...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcodecallcallcode_101Filler.json",  # noqa: E501
    ],
)
...
def test_callcodecallcallcode_101(
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0xcc06dd0686d0e620fbd99f6a023ba77440119f71"),  # noqa: E501
    )
    # Source: LLL
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.DELEGATECALL(
                    gas=0x55730,
                    address=0xCC06DD0686D0E620FBD99F6A023BA77440119F71,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
                    ret_size=0x40,
