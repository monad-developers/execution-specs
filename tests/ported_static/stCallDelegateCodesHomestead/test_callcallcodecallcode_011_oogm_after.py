...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesHomestead/callcallcodecallcode_011_OOGMAfterFiller.json",  # noqa: E501
    ],
)
...
def test_callcallcodecallcode_011_oogm_after(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xe54ccfa5e33a84943997885f0ab9c19c587d8c4f"),  # noqa: E501
    )
