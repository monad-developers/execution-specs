...
Ported from:
tests/static/state_tests/VMTests/vmBitwiseLogicOperation/iszeroFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/VMTests/vmBitwiseLogicOperation/iszeroFiller.yml",  # noqa: E501
    ],
)
