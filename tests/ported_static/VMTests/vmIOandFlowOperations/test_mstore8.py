...
Ported from:
tests/static/state_tests/VMTests/vmIOandFlowOperations/mstore8Filler.yml
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/VMTests/vmIOandFlowOperations/mstore8Filler.yml",  # noqa: E501
    ],
)
