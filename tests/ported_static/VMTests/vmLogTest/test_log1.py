...
Ported from:
tests/static/state_tests/VMTests/vmLogTest/log1Filler.yml
"""
...
def test_log1(
    ...
    pre.deploy_contract(
        code=(
            Op.LOG1(offset=0x0, size=0x0, topic_1=0x0)
    ...
    pre.deploy_contract(
        code=(
            ...
            + Op.LOG1(offset=0x1, size=0x0, topic_1=0x0)
            + Op.SSTORE(key=0x0, value=0x600D)
            + Op.STOP
        ),
        balance=0xBA1A9CE0BA1A9CE,
    ...
    pre.deploy_contract(
        code=(
            ...
            + Op.LOG1(offset=0x1F, size=0x1, topic_1=0x0)
            + Op.SSTORE(key=0x0, value=0x600D)
            + Op.STOP
        ),
        balance=0xBA1A9CE0BA1A9CE,
    ...
    pre.deploy_contract(
        code=(
            ...
            + Op.LOG1(offset=0x1F, size=0x1, topic_1=Op.SUB(0x0, 0x1))
            + Op.SSTORE(key=0x0, value=0x600D)
            + Op.STOP
        ),
        balance=0xBA1A9CE0BA1A9CE,
