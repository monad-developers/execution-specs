...
def test_log3(
    ...
    pre.deploy_contract(
        code=(
            ...
            + Op.LOG3(
                offset=0x1, size=0x0, topic_1=0x0, topic_2=0x0, topic_3=0x0
            )
            + Op.SSTORE(key=0x0, value=0x600D)
            + Op.STOP
        ),
    ...
    pre.deploy_contract(
        code=(
            ...
            + Op.LOG3(
                offset=0x0, size=0x20, topic_1=0x0, topic_2=0x0, topic_3=0x0
            )
            + Op.SSTORE(key=0x0, value=0x600D)
            + Op.STOP
        ),
    ...
    pre.deploy_contract(
        code=(
            ...
            + Op.LOG3(
                offset=0x0, size=0x1, topic_1=0x0, topic_2=0x0, topic_3=0x0
            )
            + Op.SSTORE(key=0x0, value=0x600D)
            + Op.STOP
        ),
