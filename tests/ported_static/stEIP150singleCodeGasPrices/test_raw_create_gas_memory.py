...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stEIP150singleCodeGasPrices/RawCreateGasMemoryFiller.json",  # noqa: E501
    ],
)
...
def test_raw_create_gas_memory(
    ...
    # Source: LLL
    # { [0] (GAS) (CREATE 0 0 8000) [[1]] (SUB @0 (GAS)) }
    contract = pre.deploy_contract(
        code=(
            Op.MSTORE(offset=0x0, value=Op.GAS)
            + Op.POP(Op.CREATE(value=0x0, offset=0x0, size=0x1F40))
