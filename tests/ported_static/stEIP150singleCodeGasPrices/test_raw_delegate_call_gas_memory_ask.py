...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stEIP150singleCodeGasPrices/RawDelegateCallGasMemoryAskFiller.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_raw_delegate_call_gas_memory_ask(
    ...
    # Source: LLL
    # { [0] (GAS) (DELEGATECALL 3000000 <contract:0x094f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 8000 0 8000) [[1]] (SUB @0 (GAS)) }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x8759cfbf878e9ff3cd4d3d7413fc8a44b7935cec"),  # noqa: E501
    )
    pre.deploy_contract(
    ...
    if fork >= MONAD_NINE:
        gas_adj -= 747
    callee_adj = 6648 if fork >= MONAD_NINE else 0

    post = {
        contract: Account(
            storage={1: 25605 + gas_adj, 2: 0x72467 - callee_adj}
        ),
    }
