...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stEIP150singleCodeGasPrices/RawCallGasValueTransferAskFiller.json",  # noqa: E501
    ],
)
...
def test_raw_call_gas_value_transfer_ask(
    ...
    # Source: LLL
    # { [0] (GAS) (CALL 3000000 <contract:0x094f5374fce5edbc8e2a8697c15331677e6ebf0b> 10 0 0 0 0) [[1]] (SUB @0 (GAS)) }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x75da17be9a3b7768a69e918c1574a320a6f9e59f"),  # noqa: E501
    )
    ...
    post = {
        contract: Account(storage={1: 31439 + gas_adj}),
        callee: Account(storage={2: 0x70E1C - callee_adj}),
    }
