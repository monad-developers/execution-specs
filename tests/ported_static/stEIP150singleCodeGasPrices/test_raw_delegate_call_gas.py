...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stEIP150singleCodeGasPrices/RawDelegateCallGasFiller.json",  # noqa: E501
    ],
)
...
def test_raw_delegate_call_gas(
    ...
    # Source: LLL
    # { [0] (GAS) (DELEGATECALL 30000 <contract:0x094f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 0 0 0) [[1]] (SUB @0 (GAS)) }  # noqa: E501
    ...
    post = {
        contract: Account(storage={1: 24736 + gas_adj, 2: 29998}),
    }
