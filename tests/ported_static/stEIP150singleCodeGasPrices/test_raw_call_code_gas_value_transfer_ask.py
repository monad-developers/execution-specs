...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stEIP150singleCodeGasPrices/RawCallCodeGasValueTransferAskFiller.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_raw_call_code_gas_value_transfer_ask(
    ...
    # Source: LLL
    # { [0] (GAS) (CALLCODE 3000000 <contract:0x094f5374fce5edbc8e2a8697c15331677e6ebf0b> 10 0 0 0 0) [[1]] (SUB @0 (GAS)) }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x956d6bbd9f4f04f26a090166e43c641b1c5c2ede"),  # noqa: E501
    )
    pre.deploy_contract(
    ...
    post = {
        contract: Account(
            storage={1: 31439 + gas_adj, 2: 0x70E1C - callee_adj}
        ),
    }
