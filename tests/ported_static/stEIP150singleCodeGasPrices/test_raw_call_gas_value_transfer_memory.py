...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stEIP150singleCodeGasPrices/RawCallGasValueTransferMemoryFiller.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_raw_call_gas_value_transfer_memory(
    ...
    # Source: LLL
    # { [0] (GAS) (CALL 30000 <contract:0x094f5374fce5edbc8e2a8697c15331677e6ebf0b> 10 0 8000 0 8000) [[1]] (SUB @0 (GAS)) }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xad8277a2165d713af6e54a1cefb7e5e29022b8a5"),  # noqa: E501
    )
    ...
    post = {
        contract: Account(storage={1: 32308 + gas_adj}),
        callee: Account(storage={2: 32298}),
    }
