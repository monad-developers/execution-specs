...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stEIP150singleCodeGasPrices/RawDelegateCallGasMemoryFiller.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_raw_delegate_call_gas_memory(
    ...
    # Source: LLL
    # { [0] (GAS) (DELEGATECALL 30000 <contract:0x094f5374fce5edbc8e2a8697c15331677e6ebf0b> 0 8000 0 8000) [[1]] (SUB @0 (GAS)) }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x2da2093c616ee035cc42f6a9297b0c3838d01605"),  # noqa: E501
    )
    pre.deploy_contract(
    ...
    post = {
        contract: Account(storage={1: 25605 + gas_adj, 2: 29998}),
    }
