...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stEIP150singleCodeGasPrices/RawCallCodeGasValueTransferMemoryFiller.json",  # noqa: E501
    ],
)
...
def test_raw_call_code_gas_value_transfer_memory(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xf1f3a9af4253bd7852a915ed5dcaa2360de438f6"),  # noqa: E501
    )
    ...
    post = {
        contract: Account(storage={1: 32308 + gas_adj, 2: 32298}),
    }
